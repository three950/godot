...
@onready var hand_slots: Array[BagSlot] = [
	$HBoxContainer/武器/left,
	$HBoxContainer/武器/right,
]

@onready var backpack_slots: Array[BagSlot] = [
	$HBoxContainer/防具/Slot1,
	$HBoxContainer/防具/Slot2,
	$HBoxContainer/防具/Slot3,
	$HBoxContainer/防具/Slot4,
	$HBoxContainer/防具/Slot5,
	$HBoxContainer/防具/Slot6,
]
