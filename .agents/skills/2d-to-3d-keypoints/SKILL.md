...
# 2D to 3D Key Points
1. When cards are stacked, apply an upward Y-axis offset of 0.03 to the root node. This makes the top cards physically higher in position and prioritizes them to receive raycast hits first.
